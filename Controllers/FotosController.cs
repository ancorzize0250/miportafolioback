...
public class FotosController : ControllerBase
{
    ...
    public FotosController(IFotoService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] FotoCreateDto dto)
    {
    ...
    [HttpPut("{id:long}")]
    public async Task<IActionResult> Update(long id, [FromBody] FotoUpdateDto dto)
    {
        if (!ModelState.IsValid) return BadRequest(ModelState);
