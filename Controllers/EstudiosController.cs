...
public class EstudiosController : ControllerBase
{
    ...
    public EstudiosController(IEstudioService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] EstudioCreateDto dto)
    {
    ...
    [HttpPut("{id:long}")]
    public async Task<IActionResult> Update(long id, [FromBody] EstudioUpdateDto dto)
    {
        if (!ModelState.IsValid) return BadRequest(ModelState);
